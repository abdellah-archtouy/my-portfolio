...
export default function Home() {
    return(
      ...
      <div className='absolute bg-[#D7D7D7] w-[200%] h-full  top-[70%] rotate-[-10deg]  xl:rotate-12 xl:top-[-50%] xl:h-[250%] xl:right-[70%] xl:bg-black '></div>
        <img className="  w-auto h-[90%]  absolute bottom-[-5%] right-[-10%] xl:left-[10%] xl:h-[80%]  " src="/my-picture.png" alt="my image" />
      <div className='absolute bg-[#0000006b] w-[200%] h-full  top-[70%] rotate-[-10deg] xl:hidden '></div>
      <div className='z-0 relative flex  w-full  h-[20%] xl:h-full xl:w-[60%] xl:gap-[5%] lg:pb-[0] xl:pb-[8%] lg:mb-7 xl:mb-0 xl:flex-col  justify-self-end xl:text-[#000000] pr-[3%] justify-end 2xl:justify-end xl:justify-center '>
        ...
        <div className='flex-1 flex flex-col  p-[5%] h-full gap-[2%] justify-center lg:gap-[4%]  xl:p-0 xl:h-fit xl:flex-none '>
            <h2 className='leading-none font-raleway pl-[5%]  text-[18px] sm:text-[25px] md:text-[30px] font-bold  2xl:text-[250%] xl:text-[40px] '>Hi, I am</h2>
            <h1 className='font-raleway leading-none text-[30px] sm:text-[45px] md:text-[55px] font-bold xl:text-[80px] 2xl:text-[450%] '>Abdellah Archtouy</h1>
        ...
        <div className='2xl:flex flex-col hidden  gap-[8%] 2xl:gap-[25px] '>
          <h2 className='leading-none font-raleway text-[20px] sm:text-[25px] md:text-[30px]  2xl:text-[250%] font-bold' >About Me:</h2>
          <p className='font-open-sans font-normal lg:text-[16px] xl:text-[220%] 2xl:text-[220%]  ' >Hi, I'm Abdellah, a passionate Full-Stack Developer and UI Designer currently studying 
