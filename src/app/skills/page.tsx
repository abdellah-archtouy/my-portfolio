...
function Skills() {
  return (
    <div className='flex font-montserrat pt-[30px] font-bold text-[30px]  overflow-hidden bg-[#D7D7D7] flex-col justify-around w-screen h-screen   text-black items-center '>
        ...
        <div className='flex flex-col justify-center gap-[20px] h-[50%] items-center  w-[85%]'>
          <h2 className='font-montserrat font-bold text-[30px] self-start'>USING NOW:</h2>
          <div className='flex flex-wrap flex-row gap-[10px] lg:gap-[20px] 2xl:gap-[30px]  overflow-scroll overflow-x-hidden overflow-y-auto border 2xl:border-0 border-[#0000001d] 2xl:backdrop-brightness-100 scrollbar-thin backdrop-brightness-[99%] p-[1%] scrollbar-track-transparent scrollbar-thumb-transparent  h-[100%] text-black   w-[100%] justify-start   '>
            <Html></Html>
            <Css></Css>
            <Js></Js>
            <Nextjs></Nextjs>
        ...
        <div className='flex flex-col justify-center gap-[20px] h-[30%]  items-center  w-[85%]'>
          ...
          <div className='flex flex-wrap flex-row gap-[10px] lg:gap-[20px] 2xl:gap-[30px] text-black overflow-scroll overflow-x-hidden  md:border-0  overflow-y-auto scrollbar-thin scrollbar-track-transparent  md:backdrop-brightness-100 border border-[#0000001d]  backdrop-brightness-[99%] p-[1%] scrollbar-thumb-transparent   w-[100%] h-fit  justify-start   '>
            <English/>
            <Frensh/>
            <Arabe/>
          </div>
